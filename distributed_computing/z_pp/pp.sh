...
#SBATCH --output=z_err_out/pp_%j.out
#SBATCH --error=z_err_out/pp_%j.err
...
#SBATCH --partition=med # other options are low, med, bigmem, serial.

# Specify the number of requested nodes.
#SBATCH --nodes=1
#SBATCH --exclude=c8-23,c9-70
...
python pp.py $SLURM_ARRAY_TASK_ID
